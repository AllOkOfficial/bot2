...
var TEXT map[string]string = map[string]string{
	...
	"START": `
<b>Hɪ %v , Sᴏ ɴɪᴄᴇ ᴛᴏ ᴍᴇᴇᴛ ʏᴏᴜ ! I'ᴍ %v ᴀ ᴘʀᴇ - ғᴜɴᴄᴛɪᴏɴᴇᴅ Aᴡᴇsᴏᴍᴇ ғɪʟᴛᴇʀ ʙᴏᴛ ᴡɪᴛʜ ɢʟᴏʙᴀʟ ғɪʟᴛᴇʀ sᴜᴘᴘᴏʀᴛ.<\b>
...
<b>Sᥙρρσɾ𝜏</b> : <a href='https://t.me/HombaleCinemas'>𝗛𝗲𝗿𝗲</a>
<b>𝓤ρԃα𝜏ҽട</b> : <a href='https://t.me/HombaleCinemasChat'>𝗝𝗼𝗶𝗻</a>
	`,
	...
	"START": {
		{
			...
			{Text: "🧭 Help 🧭", CallbackData: "edit(MAP)"},
